  ...
  return (
    <div ref={containerRef} className="relative h-[300vh] bg-[#c22924]">
      <section className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        {/* BACKGROUND GLOW */}
        <div className="absolute top-[-200px] left-[-150px] w-[500px] h-[500px] bg-white/10 blur-[160px] rounded-full" />
        <div className="absolute bottom-[-200px] right-[-150px] w-[500px] h-[500px] bg-black/20 blur-[180px] rounded-full" />

        {/* BIG BG TEXT */}
        <h1 className="absolute inset-0 flex items-center justify-center text-[22vw] tracking-tighter text-white/5 select-none pointer-events-none z-0 font-thin">
          DIGITAL
        </h1>

        <div className="relative z-10 w-full max-w-[95rem] mx-auto px-8 grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div>
            <motion.p
              ...
              className="uppercase tracking-[0.45em] text-white/70 text-sm mb-8 font-thin"
            >
            ...
            <motion.h2
              ...
              className="text-6xl md:text-8xl xl:text-9xl text-white leading-[0.9] tracking-tight font-thin"
            >
              Designing products
              <span className="block mt-4 text-black font-thin">
            ...
            <motion.div
              ...
              transition={{ duration: 1 }}
              className="h-[3px] bg-white/70 mt-12"
            />
            ...
            <motion.p
              ...
              className="max-w-2xl mt-10 text-white/90 text-xl md:text-2xl leading-relaxed font-thin"
            >
          ...
          >
            ...
            >
              {/* LAPTOP BODY */}
              <div className="relative w-[620px] md:w-[820px] h-[380px] md:h-[500px] bg-[#fdfcf8] rounded-[2%_3%_2%_4%/5%_2%_4%_2%] border-[3px] border-[#333] shadow-[8px_8px_0px_rgba(51,51,51,0.8),-2px_-2px_0px_rgba(51,51,51,0.1)] flex flex-col overflow-hidden z-10">
              ...
              {/* BASE */}
              <div className="relative w-[690px] md:w-[910px] h-5 bg-[#fdfcf8] border-[3px] border-[#333] rounded-[10%_10%_40%_40%/20%_20%_80%_80%] shadow-[6px_10px_0px_rgba(51,51,51,0.8)] z-0 -mt-[2px]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-2 border-b-[2px] border-x-[2px] border-[#333] rounded-b-[40%_60%_60%_40%] bg-[#eae8e0]" />
              </div>
            </motion.div>
          </motion.div>
        </div>
